...
let OpenWeatherMenuButton = GObject.registerClass(
  class OpenWeatherMenuButton extends PanelMenu.Button {
    ...
    _asyncReadyCallback(nm, res) {
      ...
      if (!this._oldConnected && this._connected) {
        ...
        if (
          ...
          Math.floor(
            new Date(now - _timeCacheCurrentWeather).getTime() / 1000
        ...
        if (
          ...
          Math.floor(
            new Date(now - _timeCacheForecastWeather).getTime() / 1000
    ...
    formatPressure(pressure) {
      ...
      switch (this._pressure_units) {
        ...
        case WeatherPressureUnits.AT:
          pressure = (pressure * 0.00101971621298).toFixed(
    ...
    rebuildCurrentWeatherUi() {
      ...
      this._sunsetIcon.set_gicon(
        this.getWeatherIcon("daytime-sunset-symbolic")
      );
    ...
    rebuildFutureWeatherUi(cnt) {
      ...
      this._forecastScrollBox.connect(
        "scroll-event",
